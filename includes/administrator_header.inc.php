...
<div id="menu" class="collapse navbar-collapse">
  <ul class="navbar-nav me-auto">
    ...
    <li class="nav-item">
      <a class="nav-link" href="manage_admin.php"><i class="fa-solid fa-user-pen"></i> Manage Admin</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="register.php"><i class="fa-solid fa-user-plus"></i> Add New Admin</a>
    </li>    
   </ul>
   <hr/>
   <ul class="navbar-nav">
