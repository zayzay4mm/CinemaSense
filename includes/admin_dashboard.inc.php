...
//total
if ($cate == "All") {
   $sql = "select count(*) as total from posts where username='$username'";
} else {
   $sql = "select count(*) as total from posts where username='$username' and category='".mysqli_real_escape_string($conn,$cate)."'";
}
...
//return count
if ($cate == "All") {
   $sql = "select * from posts where username='$username' limit 0,$end";
} else {
   $sql = "select * from posts where username='$username' and category='".mysqli_real_escape_string($conn,$cate)."' limit 0,$end";
}
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$(document).ready(function() {
  $("#search").keyup(function() {
    ...
    if (title != "") {
       $.ajax({
         url: "../includes/table_search.inc.php",
         method: "POST",
         data: {q: title},
